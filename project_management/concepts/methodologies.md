...
**Purpose**: Use this for methodology selection, implementation, and best practices. For general PM fundamentals, see [Project Management](project_management.md). For IT-specific patterns, see [IT Project Management](itpm.md).
...
> **Note**: For general PM fundamentals, see [Project Management](project_management.md). For IT-specific patterns, see [IT Project Management](itpm.md).
