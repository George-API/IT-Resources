...
| [_strategy/](_strategy/) | Shared learning approach, complexity, critical thinking, systems thinking |
...
Four stages that work as both a **learning path** and a **decision lens**. See [full approach](_strategy/01_shared_approach.md) for details.
