# Database — RDBMS Design, Performance & Operations

**Scope**: Relational database design, indexing, query optimization, transaction management, backup/recovery, and operational practices for RDBMS (OLTP and relational OLAP). For NoSQL, object storage, and OLTP vs OLAP choice, see [Data Stores](data_stores.md).

**Purpose**: Use this when designing or operating relational databases. For data pipeline patterns, see [Data Engineering](engineering.md). For data quality and integrity, see [Data Operations](operations.md).
...
> **Note**: For data pipeline patterns, see [Data Engineering](engineering.md). For data quality and integrity practices, see [Data Operations](operations.md). For data governance, see [Data Governance](governance.md). For storage types and OLTP/OLAP/NoSQL, see [Data Stores](data_stores.md). For cloud platforms, see [concepts/platform/](../platform/).
