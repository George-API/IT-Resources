...
**Purpose**: Use this when building the analytics/BI consumption layer. For pipeline patterns, see [Data Engineering](engineering.md). For governance, see [Data Governance](governance.md). For Power BI and Fabric, see [concepts/platform/](../platform/).
...
> **Note**: For pipeline patterns, see [Data Engineering](engineering.md). For governance and quality practices, see [Data Management overview](../../README.md). For Microsoft platform (Power BI, Fabric), see [Fabric](../platform/fabric.md).
