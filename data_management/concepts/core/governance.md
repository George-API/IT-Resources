...
**Purpose**: Use this when establishing data governance, designing operating models, implementing data catalogs, and managing data products. For data management overview and DMBOK alignment, see [Data Management overview](../../README.md). For security and privacy, see [Data Security](security.md). For operational practices, see [Data Operations](operations.md).
