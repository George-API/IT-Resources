...
**Purpose**: Use this when performing data analysis, building analytical models, or designing analytical workflows. For analytics engineering (transformation layer, semantic layer), see [Analytics Engineering](analytics_eng.md). For pipeline patterns, see [Data Engineering](engineering.md).
...
> **Note**: For analytics engineering (transformation layer, semantic layer, BI modeling), see [Analytics Engineering](analytics_eng.md). For data pipeline patterns, see [Data Engineering](engineering.md). For data management practices, see [Data Management overview](../../README.md). For Power BI and platforms, see [concepts/platform/](../platform/).
