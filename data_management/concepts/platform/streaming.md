...
**Purpose**: Use this when implementing real-time data pipelines, streaming analytics, and live dashboards. For platform-agnostic streaming concepts and batch pipeline patterns, see [Data Engineering](../core/engineering.md). For platform-specific patterns, see [Fabric](fabric.md) and [Databricks](databricks.md).
...
> **Note**: For batch pipeline patterns, see [Data Engineering](../core/engineering.md). For Fabric-specific patterns, see [Fabric](fabric.md). For Databricks-specific patterns, see [Databricks](databricks.md). For Power BI optimization, see [Power BI](powerbi.md).
