...
> **Note**: For infrastructure deployment, container orchestration, CI/CD, and operational practices, see [Cloud Infrastructure & Operations](infrastructure.md). Data concepts: [concepts/core/](../core/).
