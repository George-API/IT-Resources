# Azure — Data Platform & Cloud Architecture

**Scope**: Azure platform overview and enterprise architecture patterns: data platforms (ingest → lake → serving → BI), compute, networking, and hosting. Covers ADF, Synapse, and general Azure services.

**Purpose**: Use this for Azure data and cloud design and implementation. For Microsoft Fabric, see [Fabric](fabric.md). For Databricks, see [Databricks](databricks.md). For optimization practices, see [Cloud Optimization](optimization.md).
...
> **Note**: For container orchestration patterns, see [Cloud Infrastructure & Operations](infrastructure.md). For serverless patterns, see [infrastructure - Serverless](infrastructure.md#3-serverless-patterns).
...
> **Note**: For data management concepts (operating model, quality, integrity), see [Data Governance](../core/governance.md), [Data Operations](../core/operations.md), and [Data Security](../core/security.md).
...
> **Note**: For data contract concepts and operating model, see [Data Governance](../core/governance.md).
...
- [ ] Data contracts + versioning policy (see [Data Governance](../core/governance.md))
