...
**Purpose**: Use this when optimizing cloud workloads for performance, cost, and maintainability. For architecture patterns, see [Cloud Architecture](architecture.md). For Azure-specific patterns, see [Azure](azure.md).
...
> **Note**: For architecture patterns, see [Cloud Architecture](architecture.md). For Azure-specific patterns, see [Azure](azure.md). For infrastructure patterns, see [Cloud Infrastructure & Operations](infrastructure.md). Data concepts: [concepts/core/](../core/).
