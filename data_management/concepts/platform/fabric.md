...
**Scope**: Microsoft Fabric platform overview, architecture patterns, and best practices for enterprise data (ingest → lakehouse → serving → BI). Covers OneLake, Data Engineering, Warehouse, and Power BI integration.
